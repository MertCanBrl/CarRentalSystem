...
public class Admin extends Person {
    ...
    public static void addAdmin() throws SQLException{
        ...
        Connection c = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\mertb\\OneDrive\\Belgeler\\NetBeansProjects\\CarRentalProject\\CarRentalProject\\CarRentalDB\\CarRentalSystem.db");
        Statement st = c.createStatement();
        Scanner input = new Scanner(System.in);
        // GET SOME VALUES OF NEW ADMİN FROM ADMIN 
    ...
    public static boolean login(String email, String password) throws SQLException {
        ...
        try {
            ...
            String url = "jdbc:sqlite:C:\\Users\\mertb\\OneDrive\\Belgeler\\NetBeansProjects\\CarRentalProject\\CarRentalProject\\CarRentalDB\\CarRentalSystem.db";
